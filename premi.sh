...
echo -e "  Auther : ${green}IZZ STORE ® ${NC}${YELLOW}(${NC} ${green} SPS ${NC}${YELLOW})${NC}"
echo -e " © Recode By Izz Store ${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/izzstores/singleport/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/izzstores/singleport/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/izzstores/singleport/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/izzstores/singleport/main/"
...
restart_system(){
    USRSC=$(curl -sS https://raw.githubusercontent.com/izzstores/singleport/main/izin | grep $MYIP | awk '{print $2}')
    EXPSC=$(curl -sS https://raw.githubusercontent.com/izzstores/singleport/main/izin | grep $MYIP | awk '{print $3}')
